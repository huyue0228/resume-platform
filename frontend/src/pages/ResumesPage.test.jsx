vi.mock('../components/checkProcessingConfiguration', () => ({ confirmProcessingConfiguration: vi.fn().mockResolvedValue(true) }))
...
vi.mock('../api/services', () => ({
  ...
  fetchAgentDecision: vi.fn().mockResolvedValue({ data: {} }),
